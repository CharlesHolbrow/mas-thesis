...
composition. With this 
 ...
 Composers such as Debussy, Strauss, Schoenberg and
...
published examples of music with more than one simultaneous tempi
(polytempic).\cite{Greschak2003} Following Charles Ives, 


Both techniques would be explored thoroughly
throughout the modernist period. Another multi-rate effect used by
Henry Cowell, Brian Ferneyhough, and Elliott Carter, involved layering
different groupings of tuplets agains a global tempo. For example,
Elliott Carter's \textit{String Quartet No. 5} includes combinations
of tupets 3, 5, and 7. Another similar techniuqe used by composers
including Elliot Carter and George Crumb, involves notating polymeters
against a global tempo, as in the final section of Crumb's
\textit{Black Angels}.

Polytempic music, while less common than polymetric music, was also
explored in the modernist period. In Elliott Carter's earlier string
quartets


In \autoref{ch:polytempic} we derrive a mathematical approach for a
previously inaccessible genre of polytempic music.

While Composers did explore
polytempic and polymetric music in the modernist period, music in the modernist period, we must not confuse
polytempic music with polymetric music.

Composers did explore polytempic


and multi-rate effect composers wrote more precise and
directed

...
\noindent While he was not a mathematician, Cowell did understand that there
...
along together with acoustic ones. His piece, \textit{Gesang der
  Y\"{u}nglinge} (Song of the Youths, 1955-56), is widely regarded as
the first masterpiece of electronic music. It is cited as the first
multichannel pre-recorded composition to be performed in a concert
setting with multiple loudspeaker placed around the
audience,\cite{Grout2006} however, this attribution is contested by
another early example of Musique concr\`{e}te: \textit{Symphonie pour
  un Homme Seul} (Symphony for One Man Alone, 1950) by french
composers Pierre Henry and Pierre Schaeffer. Henry and Schaeffer
created an tetrahedral loudspeaker arrangement, and a rather dramatic
device, they called the \textit{Pupitre d'espace}, with large hoops
that let the user move her their to position the sounds in the
speakers with hand gestures.\cite{Holm2008}
\begin{marginfigure}

...
of time and space in music. Since far too many projects exist to cover
them all, we focus on projects that either particularly impactful or
...
acceleration, but with linear acceleration shown, both tempi rarely
land on a down beat. This is described in more detail in
\autoref{ch:polytempic}.
...
One composer did write polytempic music before \textit{New Musical
  Resources} was published. Charles Ives was an American composer
...
with the trumpet repeatedly posing a melodic question \textit{"The
  Perennial Question of Existence.''} Each question is answered by
...
made it clear the parts should not be played together. 
...
studios were quickly spreading Another composer who was drawn to

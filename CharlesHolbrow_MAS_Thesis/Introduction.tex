...
of music like EDM\sidenote[][-25mm]{EDM (Electronic Dance Music) often
  features formulaic and repetative grooves locked to a temporal grid,
  and incorporates aggressive use of digital pitch correction
  exagerating a robotic quality.}, Black MIDI\sidenote[][-3mm]{Black
...
Demoscene\sidenote{Demoscene music celebrates digital synthesis of
  compositionaly complec electronic music and audio visulizations,
  using low level sofware interfaces including the design of the
  actual synthesizer as part of the composition.}, but these styles
...
truely expressive music, we must capture percieved feelings
...
\newthought{Music and Time} are inseperable. All music flows through
...
\marginnote{Unless noted otherwise, ``compression'' is used in this
  ...
  compression.} We usually think of compression in terms of
...
cylinder.\cite{Katz2007}. A deaper study of dynamic range compression
...
and the sciences. Polato, for example, believed that all events
transpire as determinted by cause and effect. While Plato and
...
coroborated the theory.\sidenote{In 1687, Isaac Newton published
...
indeterminate music\sidenote{In music, indeterminancy refers to the
...
understand music. This paralleled the developments in phyisics and
mathematics that helped him to form his opinions about music theory.
As a nod to \emph{chance} or \emph{stochos} xenakis coined the term
...
Within a single discipline, there is an accepted hierarcy of concepts,

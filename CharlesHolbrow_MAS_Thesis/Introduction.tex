...
\paragraph{Music and Mathematics Today}
...
the foundation of stochastic music:  \polytempic, \refmod, and
...
ideas. \refmod is a software tool that lets us design and experiment
...
compression as a weapon in the \emph{loudness
  war}\sidenote[][-30mm]{Beginning in the 1990s, record labels have
  ...
  fidelity.}\cite[-5mm]{Deruty2014a} has resulted in some of today's music

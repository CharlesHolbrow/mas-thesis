...
Performer include workarounds for auditioning tracks or objects with
unique simultaneous tempi, and individual tempos can even be automated
...
any audio sequencing software we tried. 

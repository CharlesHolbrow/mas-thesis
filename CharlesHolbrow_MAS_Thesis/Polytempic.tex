...
music composition.\sidenote[][-5mm]{Works by Italian composer Luciano
  ...
  written for a virtuostic soloists. Each was for a different
...
virtuostic skills required to play the music, composers also wrote
...
While metric modulation is a tecnique for changing meter, and
...
deccelerate relative to the others. The piece was so difficult, that
...
manipulate rhytm and tempo. Flexible digital audio workstations (DAWs)
...
section~\ref{sec:polytempic-solution}. One project, \textit{Realtime
  Represenation and Gestural Control lf Musical
...
the time, neither Bryn nor I knew that Tod Machover had initially

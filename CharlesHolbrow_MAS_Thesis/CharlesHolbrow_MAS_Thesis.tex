...
There is a long history of parellel between music and math. Anyone
familiar with both can list endless ways that music is applied
mathematics. We can describe musical pitches, and rhythms with numbers
or mathematical relationships. There is a tempation to describe music
as applied mathematics, but this tempation comes with an important
side-effect that has become increasingly evident as computers,
amplifiers and electronics become our primary tools for creating
manipulating, and performing music.

A vocalist does not abruptly change a pitch, but gently and carefuly
lands on a pitch. A jazz musician might play slightly ``behind the
beat''. A classical performer knows how to holds a fermata \emph{just
  long enough}. These intentional human artifacts artifacts are
characterised more by a \emph{feeling} than by a formula. Of course
computers do not understand feelings, so when we teach computers to
play music, we try to describe feelings with formulas. 


Autotune music, black midi, electronic dance music, data compression
music. 


 and
these tools speak the language of mathematics. To program a computer
to understand and process music, we

become our primary tools for creating and manipulating
music, we risk supressing the human imperfections that make acoustic
performances so alluring. 

Electronic Dance Music

computers can only deal with mathematics. 
human side of music

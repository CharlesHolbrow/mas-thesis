...
implied that all events that transpire are the result of cause and
...
noticed that more contemporary fields like \emph{probability theory} and
\emph{fuzzy logic} generalize and expand on the \TODO{earlier}
...
probability to describe the material world. However, Xenakis believed
the evolution of musical theory was supressed by serial music, which
he described as embodying ``virtually absolute
...
was able to identify how even in serialism and indeterminate composers
were only utilizing a small subset of algebraic theory. In his own
music, Xenakis wanted to generalize the and expand the causal

...
\TODO{I'll fill this out more as I progress, but this is basically the
  ...
  math chapter}
\begin{enumerate}
\item Introduction and  Historical Context % this should go first, as
                                % it primes for the movitation
\item motivation
...
\newthought{The Phillips Pavilion}, a Gesamtkunstwerk stands out as an

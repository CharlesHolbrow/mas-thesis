...
% \sidenote after period, not before, because it is for the sentence,
% not the word.
% http://graphicdesign.stackexchange.com/questions/15342/footnote-endnote-references-before-or-after-punctuation-comma-full-stop-perio
flexible tools in the audio engineer's toolkit.\sidenote{Be aware of
  the diference between audio data compression and audio dynamic range
  compression. Data compression is the practice of reducing the
  filesize of digitally encoded audio data. In this thesis, I use
  \textit{compression} to mean \textit{dynamic range compression}.}

...
\paragraph{Polymath} The architectural evolution of the pavillion from Le Corbusier's early
designs (figure~\ref{fig:le-corbusier-sketch}) through Xenakis'
iterations (figure~\ref{fig:xenakis-draw}), illustrates the impact
that Xenakis had on the project. The \textit{Philips Technical
 Review}\cite{philips1958} gives a wonderfully detailed account of
Xenakis' process: 
\begin{enumerate}
...
\item ...leading him to consider ruled surfaces such as the conoid and
  hyperbolic parabaloid. \sidenote{\TODO{Explain}}
\end{enumerate}
...
insisted that all events that transpire are the result of cause and
...
and mathematics coroborated the theory. 
...
19th century when statical theories in physics began to include
probabilistic notions.\sidenote{The Maxwell–Boltzmann distribution,
  ...
  \url{http://plato.stanford.edu/entries/statphys-statmech/}} 
Newer studies like probability theory and fuzzy logic generalize and
expand on the theory of causality. 

Xenakis noticed that several decades later, musicians began to use serialism

Determinism in music can be described with the 

Xenakis saw music theory as a sub-category of mathematics. While
musicians use a different vocabulary, they also use mathematical
principles to describe and compose music. They had begun to use
probability in composition, the same what that physicits had begun to
use probability to describe the material world, but the evolution of
musical theory was supressed by serial music, which Xenakis
described as ``virtually absolute determinism.'' Because he understood
mathematics as well as music, he was able to see how composers were
only utilizing a tiny subset of mathematical theory. 


He had experienced the devastation of World War II first hand, and
like other composers at the time, 
 wanted to free music from conventions of his time, and he
wanted to free architecture from spatial paradigms. He saw 
...
Xenakis saw both music and architecture as mediums locked as locked in

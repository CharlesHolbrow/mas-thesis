...
If we follow the evolution of the pavillion from Le Corbusier's early
designs (figure~\ref{fig:le-corbusier-sketch}) through Xenakis'
iterations (figure~\ref{fig:xenakis-draw}), we can clearly see the
impact that Xenakis' diverse skillset had on the project. Xenakis was
familiar with the practical mechanical properties of pre-stressed
concrete, he understood that parallel surfaces would cause repeated
acoustic reflections (negatively impacting audio quality), and he
understood the mathematical forumulations of hyperbolic parabaloid
forms (the 3-dimensional shapes found in the walls of the pavilion).\cite{philips1958}

\TODO{Connect to his music. It required a very diverse background to
...
\begin{quotation}
  ...
  human sciences, and history; in short, a sort of universality, but
  one based opon, guided by and oriented toward forms and
  architectures.'' \cite{russolo1986art}
\end{quotation}

...
\end{enumerate}
We can use the \refmod tool to prototype potential layouts and gain
some intuition about our focal points. The curved black line in the
...
a sound source and the red line represent sound propagation.  Each red
line emanating from a sound source is the same length, no matter how
many times it has been reflected. If it is possible to adjust the
length of the red lines such that each one ends at the same spot, it
shows that reflections will arrive at that spot in
